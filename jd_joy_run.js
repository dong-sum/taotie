...
!function (t, r) { "object" == typeof exports ? module.exports = exports = r() : "function" == typeof define && define.amd ? define([], r) : t.CryptoJS = r() }(this, function () {
  ...
  let friendsArr = ["lonma","lonma","wdwhQapzBAKbto","wdwhQapzBAKbto","39441141-62909649","39441141-62909649","jd_QYqbUXqisOlY"]
  ...
  function enterRoom(invitePin) {
    return new Promise(resolve => {
      ...
      let opt = {
        ...
        url: `//替换${encodeURI(invitePin)}&inviteSource=task_invite&shareSource=weapp&inviteTimeStamp=${Date.now()}`,
        method: "GET",
        data: {},
        credentials: "include",
  ...
  function helpInviteFriend(friendPin) {
    return new Promise((resolve) => {
      ...
      let opt = {
        // url: "//jdjoy.jd.com/common/pet/getPetTaskConfig?reqSource=h5",
        url: `替换=${encodeURI(friendPin)}&reqSource=h5`,
        method: "GET",
        data: {},
        credentials: "include",
        header: {"content-type": "application/json"}
  ...
  function combatHelp(friendPin) {
    return new Promise(resolve => {
      ...
      let opt = {
        // url: "//jdjoy.jd.com/common/pet/getPetTaskConfig?reqSource=h5",
        url: `//draw.jdfcloud.com//common/pet/combat/help?friendPin=${encodeURI(friendPin)}`,
        method: "GET",
        data: {},
        credentials: "include",
        header: {"content-type": "application/json"}
