...
let inviteCodes = [
  'QNq7lb3oDUajMs_WTop3g2yWroQVR0MtQ94@W9GikI31AUDRD_jIU4t_mslkydJx6DThUrBGLP9nJTzjpTI@H4zhzO2lRQu-eIGTF9010lJsqc6amauo1GlWDuluXSV6RpMbZS0',
  'QNq7lb3oDUajMs_WTop3g2yWroQVR0MtQ94@W9GikI31AUDRD_jIU4t_mslkydJx6DThUrBGLP9nJTzjpTI@H4zhzO2lRQu-eIGTF9010lJsqc6amauo1GlWDuluXSV6RpMbZS0',
]
!(async () => {
  if (!cookiesArr[0]) {
  ...
  await requireConfig();https://tool.lu/js
...
function readShareCode() {
  ...
  return new Promise(async resolve => {
    $.get({url: `替换`, 'timeout': 10000}, (err, resp, data) => {
      try {
        if (err) {
          console.log(`${JSON.stringify(err)}`)
          console.log(`${$.name} API请求失败，请检查网路重试`)
