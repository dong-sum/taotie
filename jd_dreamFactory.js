...
let tuanActiveId = `P529ps29ruxRs8jpkoxrQg==`;
const jxOpenUrl = `openjd://virtual?params=%7B%20%22category%22:%20%22jump%22,%20%22des%22:%20%22m%22,%20%22url%22:%20%22https://wqsd.jd.com/pingou/dream_factory/index.html%22%20%7D`;
let cookiesArr = [], cookie = '', message = '', allMessage = '';
const inviteCodes = ['EHLD-QW8SZJ8yucpXq_EwA==@zUq0ZsUJcMEXZlB_6zUOww==@xU3e4Ap6NfU5bAbfw2J9oISveIS2x5vRDJ0S_2fEJdU='
];
...
async function joinLeaderTuan() {
  $.tuanIdS = null;
  if (!$.tuanIdS) await updateTuanIdsCDN('https://cdn.jsdelivr.net/gh/lonma/JD/updatedreamtuanid.json');
...
function requireConfig() {
  return new Promise(async resolve => {
    await updateTuanIdsCDN('https://cdn.jsdelivr.net/gh/lonma/JD/updatedreamtuanid.json');
